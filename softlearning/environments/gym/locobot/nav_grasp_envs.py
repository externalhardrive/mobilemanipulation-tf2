...
class MixedLocobotNavigationEnv(RoomEnv):
    ...
    def get_observation(self):
        ...
        obs["velocity"] = np.clip(self.current_velocity / self.max_velocity, -1.0, 1.0)
    ...
    def step(self, action):
        ...
        self.current_velocity += np.array(action) * self.velocity_change_scale
        self.current_velocity = np.clip(self.current_velocity, -self.max_velocity, self.max_velocity)
        new_left, new_right = self.current_velocity
