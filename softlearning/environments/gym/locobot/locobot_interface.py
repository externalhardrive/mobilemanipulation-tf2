...
class PybulletInterface:
    ...
    def move_ee(self, pos, wrist_rotate=0, steps=30, max_velocity=float("inf"), ik_steps=150):
    ...
    def apply_continuous_action(self, action, max_velocity=float("inf")):
        ...
        self.p.setJointMotorControl2(self.robot, 16, self.p.POSITION_CONTROL, new_wrist_angle, maxVelocity=max_velocity)
